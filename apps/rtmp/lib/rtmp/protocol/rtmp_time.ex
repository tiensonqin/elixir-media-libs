defmodule Rtmp.Protocol.RtmpTime do
  ...
  @type rtmp_timestamp :: 0..2_147_483_647
  ...
  ## Examples
    ...
    1000
  """
  def to_rtmp_timestamp(timestamp) when timestamp < 0,
    do: to_rtmp_timestamp(@max_timestamp + timestamp)

  def to_rtmp_timestamp(timestamp) when timestamp > @max_timestamp,
    do: to_rtmp_timestamp(timestamp - @max_timestamp)
